          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="relative h-64 rounded-2xl overflow-hidden shadow-card-hover">
                <iframe
                  src={`https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3503.8147848596767!2d${CONTACT.coordinates.lng}!3d${CONTACT.coordinates.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1702578000000`}
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  loading="lazy"
                  title="GridGo Interiors Location - New Delhi"
                />
              </div>
            </motion.div>
