    ...
    >
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className="fixed inset-0 top-auto w-full glass-card z-[99999] animate-slide-up rounded-tl-3xl rounded-tr-3xl shadow-luxury-hover flex flex-col">
            <div className="h-full flex flex-col">
              ...
              {/* Bottom Section - Divider + CTA + Socials */}
              <div className="border-t border-white/10 bg-gradient-to-t from-[#0a0e27] to-transparent p-6 space-y-4">
                <Button3D
                ...
                <div className="flex items-center justify-center gap-4 pt-4">
                  <a
                    ...
                    className="p-3 text-[#b4b4b4] hover:text-white hover:bg-white/10 rounded-lg transition-all"
